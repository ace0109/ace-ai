...
class RAGService:
    ...
    def get_all_documents(self, limit: Optional[int] = None, offset: Optional[int] = None) -> Dict:
        """
        获取所有文档
        ...
        try:
            ...
            return self.vector_store.get(include=['metadatas', 'documents'], limit=limit, offset=offset)
